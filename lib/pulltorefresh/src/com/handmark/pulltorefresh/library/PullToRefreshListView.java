...
public class PullToRefreshListView extends PullToRefreshAdapterViewBase<ListView> {
	...
	class InternalListView extends ListView implements EmptyViewMethodAccessor {
		...
		protected void dispatchDraw(Canvas canvas) {
			try {
				...
				Log.e("pull_to_refresh", e.getMessage());
			}
		}
	}
	...
	protected final ListView createRefreshableView(Context context, AttributeSet attrs) {
		...
		if (mode == MODE_PULL_DOWN_TO_REFRESH || mode == MODE_BOTH) {
			...
			mHeaderLoadingView = new LoadingLayout(context, MODE_PULL_DOWN_TO_REFRESH, releaseLabel, pullLabel, refreshingLabel, a);
		...
		if (mode == MODE_PULL_UP_TO_REFRESH || mode == MODE_BOTH) {
			...
			mFooterLoadingView = new LoadingLayout(context, MODE_PULL_UP_TO_REFRESH, releaseLabel, pullLabel, refreshingLabel, a);
